...
const DetailsCoffee = () => {
    ...
    return (
        ...
        <div className='bg-addCoffee py-4 px-4 sm:px-6 lg:px-8 min-h-screen'>
            <div className="max-w-5xl mx-auto"> 
                ...
                <div className="mb-8">
                    <Link
                        to="/" 
                        className="flex justify-center items-center text-2xl rancho-font text-[#374151] hover:text-[#331A15] transition-colors duration-200"
                    > ← Back to home
                    </Link>
                </div>

                {/* Main Content Card */}
                <div className="bg-[#F4F3F0] rounded-lg shadow-xl p-8 sm:p-10 flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-12 lg:gap-16">
                    ...
                    <div className="flex-grow text-left w-full md:w-auto">
                        ...
                        <div className="space-y-2.5 text-base md:text-lg">
                            ...
                            <p><span className="font-semibold text-slate-800">Quantity:</span> <span className="text-slate-600">{quantity}</span></p>
                            <p><span className="font-semibold text-slate-800">Price:</span> <span className="text-slate-600">{price} Taka</span></p>
