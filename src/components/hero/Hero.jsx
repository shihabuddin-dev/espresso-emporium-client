    ...
    <div className="bg-hero -mt-6">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-2/3 lg:w-1/2 text-left md:pl-8">
              ...
              <Button className="border-none text-gray-800 font-semibold">
                {" "}
                Learn More
              </Button>
            </div>
      ...
      <div className="bg-[#F5F0E1] py-10 sm:py-12">
        <div className="max-w-4xl mx-auto px-4 md:px-0">
          <p className="text-3xl rancho-font text-shadow-primary text-center mb-2">
            <Link to="/users">Go Dashboard</Link>
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 text-center">
            {features.map((feature, index) => (
              <div key={index} className="flex flex-col items-center p-4">
                ...
                <p className="text-sm text-[#7A5C58]">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
